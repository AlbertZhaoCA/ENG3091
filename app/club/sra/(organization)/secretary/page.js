  ...
  return (
    <div className="min-h-screen pt-24">
      <LightProfile
        ...
        person={{
          name: "余益多",
          intro: "27 Class Computer Science",
          contact: "WeChat: imyyid",
          media: svgArray,
        }}
      />
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-12 text-center pt-12">
        <p className="mx-auto my-4 -mt-4 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
          Welcome to 
        ...
        <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
          ...
          <span className="inline-block">Assist with Precision</span>
        </h1>

        <p className="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
          <span className="inline-block">
          Manage the daily administrative affairs of the association, including meeting minutes, document management, performance evaluations, event sign-ins, internal communication, as well as procurement and reimbursement accounting for large events.          </span>
