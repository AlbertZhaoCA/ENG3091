...
export default function Page() {
  ...
  return (
    <div className="min-h-screen pt-24">
      <LightProfile
        onChildClick={[handleChildClick, handleQQChildClick]}
        avatar={avatarImg}
        person={{
          name: "陈嘉悦 (Cynthia)",
          intro: "27 Class Finance",
          contact: "WeChat and QQ",
          media: svgArray,
        }}
      />
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8  pb-16 text-center lg:pt-10">
        <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
          ...
          <span className="inline-block">All Challenges</span>
        </h1>

        <p className="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
          <span className="inline-block">
          The Planning Department is a core department of the Science and Technology Research Association, mainly responsible for planning and organizing various activities of the association. This includes organizing and coordinating various affairs of events,
          </span>
